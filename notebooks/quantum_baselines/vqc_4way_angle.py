...
RESULTS_PATH = Path("results/vqc_4way_anlge_enc_results.json")
...
def run_single_experiment(dataset_name, n_samples, seed,
    ...
    """Run a single 8-way VQC experiment."""
...
def run_all_experiments(resume=True):
    """Run all 8-way VQC experiments with resume support."""

    print("\n" + "=" * 70)
    print("VARIATIONAL QUANTUM CLASSIFIER - 8-WAY MULTICLASS")
    ...
    if RESULTS_PATH.exists() and resume:
        ...
        all_results = {
            "experiment_info": {
                "model_type":      "variational_quantum_classifier_8way",
